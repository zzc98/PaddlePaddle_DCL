...
| FGVC-Aircraft | ResNet-50 | 93.0     | 91.6 | 93.0（论文中swap_num=2） |
...
复现好的训练权重和日志下载链接：[百度网盘](https://pan.baidu.com/s/1Cbn_QpFwn7MeVsrg1qFXSQ?pwd=xdbx )，提取码： xdbx。
...
--crop=448 \
--swap_num=2
# --swap_num=7和参考repo一致（参考repo并没有针对此数据集修改此参数），但是按照论文配置应为--swap_num=2
```
